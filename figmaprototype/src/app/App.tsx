...
const programmeData = [
  { id: 'prog-1', name: 'SRHR Youth', progress: 78, color: '#2196F3' },
  { id: 'prog-2', name: 'GBV Prevention', progress: 85, color: '#2196F3' },
  { id: 'prog-3', name: 'Humanitarian Response', progress: 62, color: '#2196F3' },
  { id: 'prog-4', name: 'Population Data', progress: 91, color: '#2196F3' },
  { id: 'prog-5', name: 'Capacity Building', progress: 74, color: '#2196F3' },
];

const indicatorStatusData = [
  { id: 'ind-1', name: 'Achieved', value: 24, color: '#4CAF50' },
  { id: 'ind-2', name: 'On Track', value: 38, color: '#4CAF50' },
  { id: 'ind-3', name: 'Watch', value: 12, color: '#FFA726' },
  { id: 'ind-4', name: 'Off Track', value: 8, color: '#EF5350' },
  { id: 'ind-5', name: 'No Data', value: 6, color: '#9E9E9E' },
];

const participantData = [
  { id: 'part-1', category: '10-14', female: 3420, male: 2890 },
  { id: 'part-2', category: '15-19', female: 5670, male: 4320 },
  { id: 'part-3', category: '20-24', female: 4230, male: 3560 },
  { id: 'part-4', category: '25-29', female: 2890, male: 2340 },
  { id: 'part-5', category: '30+', female: 1780, male: 1450 },
];
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-5 gap-4 mb-6">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                ...
                <div className="text-xs text-gray-600 mt-1">$2.8M of $3.9M</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-12 gap-5">
              <div className="col-span-8 space-y-5">
                <div className="bg-white border border-gray-200 rounded-lg p-5 shadow-sm">
                  ...
                  <ResponsiveContainer width="100%" height={180}>
                    <BarChart data={programmeData} layout="vertical">
                      ...
                      <YAxis dataKey="name" type="category" width={150} tick={{ fontSize: 12 }} stroke="#666" />
                      <Tooltip contentStyle={{ borderRadius: 8 }} />
                      <Bar dataKey="progress" fill="#2196F3" radius={[0, 4, 4, 0]} />
                    </BarChart>
                  </ResponsiveContainer>
                </div>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-5 shadow-sm">
                    ...
                    <ResponsiveContainer width="100%" height={180}>
                      <BarChart data={participantData}>
                        ...
                        <XAxis dataKey="category" tick={{ fontSize: 11 }} stroke="#666" />
                        <YAxis tick={{ fontSize: 11 }} stroke="#666" />
                        <Tooltip contentStyle={{ borderRadius: 8 }} />
                        <Legend wrapperStyle={{ fontSize: 11 }} />
                        <Bar dataKey="female" fill="#E95420" name="Female" />
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-5 shadow-sm">
                  ...
                  <div className="h-52 bg-gray-100 rounded-lg flex items-center justify-center border border-gray-200">
              ...
              <div className="col-span-4">
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-5 shadow-sm sticky top-0">
